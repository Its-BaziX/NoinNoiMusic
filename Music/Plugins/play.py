...
async def play(_, message: Message):
    ...
    if await is_active_chat(chat_id):
        ...
        cpl=(f"downloads/{_chat_}https://telegra.ph/file/e3c1e773a8e0fd11f53ed.jpg")     
...
async def popat(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"6️ <b>{title6}</b>\n  ┗  💡 <u>__[NOINOI](https://t.me/{BOT_USERNAME}?start=info_{ID6})__</u>\n\n7️ <b>{title7}</b>\n  ┗  💡 <u>__[NOINOI](https://t.me/{BOT_USERNAME}?start=info_{ID7})__</u>\n\n8️ <b>{title8}</b>\n  ┗  💡 <u>__[NOINOI](https://t.me/{BOT_USERNAME}?start=info_{ID8})__</u>\n\n9️ <b>{title9}</b>\n  ┗  💡 <u>__[NOINOI](https://t.me/{BOT_USERNAME}?start=info_{ID9})__</u>\n\n10 <b>{title10}</b>\n  ┗  💡 <u>__[NOINOI](https://t.me/{BOT_USERNAME}?start=info_{ID10})__</u>",    
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return    
